...
#app imports
from db import create_database, get_database
...
#TODO: Report system
@site.route('/report', methods=['POST'])
def report():
    pass
...
@site.route('/profile/<username>', methods=['GET', 'PATCH', 'DELETE'])
